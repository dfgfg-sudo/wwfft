 ...
 *   - 编码自动检测，乱码自动修复
 */
import { KnowledgeBatchUploader, type BatchUploadInput, type BatchUploadResult, type KnowledgeDocument } from './uploader';
import { SECURITY_CONFIG, validateFileType, sanitizePath, detectEncoding } from './security';
import { FileParser, type ParseResult } from './parser';
import { ZipProcessor, type ZipFileInfo } from './zip-processor';
export { KnowledgeBatchUploader, FileParser, ZipProcessor, SECURITY_CONFIG, validateFileType, sanitizePath, detectEncoding, };
export type { BatchUploadInput, BatchUploadResult, KnowledgeDocument, ParseResult, ZipFileInfo, };
/**
 ...
 * ```
 */
export declare function batchUploadFromZip(zipBuffer: Buffer | Uint8Array, options?: Partial<BatchUploadInput['options']>): Promise<BatchUploadResult>;
