 ...
 * @returns 是否允许
 */
function validateFileType(fileName, customAllowed) {
    const ext = getExtension(fileName).toLowerCase();
    if (!ext)
        return false;
    const allowed = customAllowed || exports.SECURITY_CONFIG.allowedExtensions;
...
function sanitizePath(filePath) {
    ...
    // 检查所有禁止模式
    for (const pattern of exports.SECURITY_CONFIG.forbiddenPathPatterns) {
...
module.exports = { validateFileType, sanitizePath, detectEncoding, isValidUtf8, cp, ... };
